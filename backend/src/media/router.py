...
from src.media.schema import PresignedUploadResponse, mediaMetaData , mediaDetails , PresignedViewResponse
...
@router.post("/{me_id}/view",response_model=PresignedViewResponse, status_code= status.HTTP_200_OK)
async def consumeAndLog(
    ...
    try :
        return await consume_and_log_image_view(
            me_id=me_id ,
